...
public class ApplicationActivityListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.UI.Security.ApplicationActivityListener, Esri.ArcGISRuntime", ApplicationActivityListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ApplicationActivityListener.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.Security.ApplicationActivityListener, Esri.ArcGISRuntime", "", this, new java.lang.Object[] {  });
	}
