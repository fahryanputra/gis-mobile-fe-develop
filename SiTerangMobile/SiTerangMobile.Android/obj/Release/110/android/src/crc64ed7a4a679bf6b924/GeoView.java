...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.UI.Controls.GeoView, Esri.ArcGISRuntime.Android", GeoView.class, __md_methods);
	}
	...
	public GeoView (android.content.Context p0)
	{
		...
		if (getClass () == GeoView.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.Controls.GeoView, Esri.ArcGISRuntime.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public GeoView (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == GeoView.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.Controls.GeoView, Esri.ArcGISRuntime.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public GeoView (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == GeoView.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.Controls.GeoView, Esri.ArcGISRuntime.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
